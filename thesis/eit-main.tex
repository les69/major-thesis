...
\def\mytitle{Improving house security using an Internet of Things infrastructure:} % Title of thesis
...
\def\myacdsuptit{Professor}% Title of your Academic Supervisor from ELTE
\def\myacdsupen{Marchese Maurizio} % Your Academic Supervisor from your Entry University
\def\myacdsupentit{Professor}% Title of your Academic Supervisor from your Entry University
\def\myentryuni{University of Trento}% Your Entry University
...
\def\myindcom{Ericsson Hungary}% Your Industrial Supervisor's company
...
\begin{center}
    ...
    %%\vspace{0.1cm}
    %%{\fontsize{20.74}{22}  \scshape  infrastructure}\\
\vspace{0.5cm}
%%\newline
%%{\fontsize{15.55}{30}  \scshape  \mysubtitle}
{\fontsize{15}{22}  \scshape  A Microservice oriented approach to integration}\\
%%{\fontsize{15.5}{22}  \scshape  }\\
