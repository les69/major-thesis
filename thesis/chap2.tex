...
\textbf{SmartThings}[21] is another ecosystem from \textit{Samsungs} with many similarities
...
is also called \textit{Componentization via Services}[7], where a component is defined
