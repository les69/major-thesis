...
\textbf{Nest} is a home automation producer of smart devices, such
as thermostats, cameras and alarms.
...
has the logic to deal with the new module. Subsequently the module will
